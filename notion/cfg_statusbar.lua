...
mod_statusbar.create{
	...
	--template="%wsname_pre [%wsname] %wsname_post %filler%systray %date",
	template="%wsname_full %filler%systray [ %date || %load ]",
...
defbindings("WStatusBar", {
	mpress("Button1", "WScreen.switch_prev(_)"),
	mpress("Button3", "WScreen.switch_next(_)"),
})
